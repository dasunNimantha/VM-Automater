...
sudo apt install apt-utils bison automake autoconf build-essential ca-certificates curl dh-autoreconf doxygen \
  flex gawk git iputils-ping libcurl4-gnutls-dev libcurl4-openssl-dev libexpat1-dev libgeoip-dev liblmdb-dev \
  libpcre3-dev libpcre++-dev libssl-dev libtool libxml2 libxml2-dev libyajl-dev locales \
  lua5.3-dev pkgconf pkg-config wget zlib1g-dev zlibc libxslt-dev libgd-dev
